...
```{r histogram_steps_per_day, fig.height=5}
...
```{r plot_steps_per_interval, fig.height=5}
...
#### Histogram
```{r histogram_imputed, fig.height=5}
...
```{r histogram_original, fig.height=5}
hist(daysum.DF$value, col="red", xlab="Steps per day", breaks=20, 
	main="Histogram of Total Number of Steps Per Day")
```
#### Mean and median 
...
```{r compare_weekdays_and_weekends}
...
```{r lattice_compare_weekdays_and_weekends, fig.width=8}
# weekday vs weekend
